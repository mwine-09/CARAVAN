...
class _GoogleMapsViewState extends State<GoogleMapsView> {
  ...
  // variable to hold the destinationCoordinates
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            const Text("Dropped Pin Coordinates:"),
                            Text(
                              "Latitude: ${_droppedPin!.position.latitude.toStringAsFixed(6)}, Longitude: ${_droppedPin!.position.longitude.toStringAsFixed(6)}",
                            ),
                          ],
                        ),
                      ),
